...
function updateRecords(records, id, prop, value) {
  if (prop !== "tracks" && value !== ""){  //Use an if...else if chain to check the needed steps.
    records[id][prop] = value; //To access the value of a key in this object, you will use records[id][prop].
  } else if (prop === "tracks" && records[id].hasOwnProperty("tracks") === false){ //You can’t push to an array that doesn’t exist. Use hasOwnProperty to check first.
